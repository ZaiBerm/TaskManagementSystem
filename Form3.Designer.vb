...
Partial Class Form3
    ...
    Private Sub InitializeComponent()
        ...
        Guna2CustomGradientPanel1.FillColor4 = Color.FromArgb(CByte(64), CByte(0), CByte(64))
        ...
        Guna2Panel4.CustomBorderThickness = New Padding(10)
        ...
        Guna2CustomGradientPanel2.Controls.Add(FlowLayoutPanel3)
        ...
        Guna2CustomGradientPanel2.FillColor2 = Color.FromArgb(CByte(64), CByte(0), CByte(64))
        Guna2CustomGradientPanel2.FillColor3 = Color.FromArgb(CByte(64), CByte(0), CByte(64))
        Guna2CustomGradientPanel2.FillColor4 = Color.FromArgb(CByte(64), CByte(0), CByte(64))
        Guna2CustomGradientPanel2.Location = New Point(391, 0)
        Guna2CustomGradientPanel2.Name = "Guna2CustomGradientPanel2"
        Guna2CustomGradientPanel2.ShadowDecoration.CustomizableEdges = CustomizableEdges8
        Guna2CustomGradientPanel2.Size = New Size(486, 806)
        ...
        Guna2Button3.FillColor = Color.FromArgb(CByte(64), CByte(64), CByte(64))
        Guna2Button3.Font = New Font("Arial Rounded MT Bold", 16.2F, FontStyle.Regular, GraphicsUnit.Point)
        Guna2Button3.ForeColor = Color.White
        Guna2Button3.Location = New Point(64, 729)
        Guna2Button3.Margin = New Padding(3, 2, 3, 2)
        Guna2Button3.Name = "Guna2Button3"
        Guna2Button3.ShadowDecoration.CustomizableEdges = CustomizableEdges6
        Guna2Button3.Size = New Size(357, 57)
        Guna2Button3.TabIndex = 12
        Guna2Button3.Text = "Create Team Project"
        ' 
        ' FlowLayoutPanel3
        ' 
        FlowLayoutPanel3.AutoScroll = True
        FlowLayoutPanel3.BackColor = Color.Transparent
        FlowLayoutPanel3.Location = New Point(16, 85)
        FlowLayoutPanel3.Name = "FlowLayoutPanel3"
        FlowLayoutPanel3.Size = New Size(456, 615)
        ...
        Label5.Font = New Font("Arial Rounded MT Bold", 36F, FontStyle.Regular, GraphicsUnit.Point)
        Label5.ForeColor = Color.WhiteSmoke
        Label5.Location = New Point(19, 21)
        Label5.Name = "Label5"
        Label5.Size = New Size(195, 55)
        Label5.TabIndex = 14
        Label5.Text = "Teams:"
        ' 
        ' Guna2Button2
        ...
        FlowLayoutPanel2.Location = New Point(883, 85)
        FlowLayoutPanel2.Name = "FlowLayoutPanel2"
        FlowLayoutPanel2.Size = New Size(458, 615)
        ...
        Label4.Name = "Label4"
        Label4.Size = New Size(372, 55)
        Label4.TabIndex = 17
        Label4.Text = "Personal Task:"
        ' 
        ' Guna2TileButton1
        ' 
        ...
        Guna2TileButton1.Location = New Point(1307, -4)
